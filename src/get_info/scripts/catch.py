...
class MoveItControlDemo:
    ...
    def attach_objects(self, model_name_1, link_name_1, model_name_2, link_name_2):
        return attach_links(model_name_1, link_name_1, model_name_2, link_name_2)
    ...
    def main(self):
        ...
        self.execute_named_target("grasp")
        
        
        self.execute_named_target("catch")
        self.attach_objects("unit_cylinder", "link", "robot", "right_gripper")
